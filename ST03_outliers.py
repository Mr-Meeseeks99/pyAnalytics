...
#Z-score
z = np.abs(stats.zscore(boston.crim))
print(z)
...
dataDF.columns
dataDF.shape
sns.boxplot(x = dataDF.mpg)
z = np.abs(stats.zscore(dataDF.mpg))
print(z)
print(np.where(z > 3))
sns.boxplot(x = dataDF.cyl)
sns.boxplot(x = dataDF.disp)
sns.boxplot(x = dataDF.hp)
z1 = np.abs(stats.zscore(dataDF.hp))
print(z1)
print(np.where(z1 > 3))
sns.boxplot(x = dataDF.drat)
sns.boxplot(x = dataDF.wt)
z2 = np.abs(stats.zscore(dataDF.drat))
print(z2)
print(np.where(z2 > 3))
sns.boxplot(x = dataDF.qsec)
z3 = np.abs(stats.zscore(dataDF.qsec))
print(z3)
print(np.where(z3 > 3))
sns.boxplot(x = dataDF.vs)
sns.boxplot(x = dataDF.am)
sns.boxplot(x = dataDF.gear)
sns.boxplot(x = dataDF.carb)
z4 = np.abs(stats.zscore(dataDF.carb))
print(z4)
print(np.where(z4 > 3))
dataDF.carb
